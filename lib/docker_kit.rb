require "docker_kit/version"
require 'ostruct'
require 'contracts'
require 'dry-auto_inject'
require 'docker_kit/extensions/colored_string'
require 'docker_kit/extensions/contracts'

$LOAD_PATH << File.join(__dir__, 'docker_kit')
...
module DockerKit
  ...
  class << self
    ...
    def build_helper(&proc)
      DockerKit::Core::ContextHelper::BaseHelper.class_exec(&proc)
    end
  end
end
