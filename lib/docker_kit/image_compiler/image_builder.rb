class DockerKit::ImageCompiler::ImageBuilder
  include DockerKit::Import[
    "shell.docker_commands",
    "image_compiler.version_tag_builder"
  ]

  Contract DockerKit::Shell::AbstractShell, DockerKit::Core::Image, String, KeywordArgs[
    args: Maybe[Any],
    context_helper: Maybe[DockerKit::Core::ContextHelper]
  ] => Any
