class DockerKit::ImageCompiler::ImageDependencyResolver
  CircularDependencyError = Class.new(DockerKit::Error)
  DependencyNotFoundError = Class.new(DockerKit::NotFoundError)
