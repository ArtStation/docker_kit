...
RSpec.describe Indocker::Core::EnvFiles::EnvFileStore do
  ...
  context "#get_global" do
    it "returns global env_file" do
      env_file = Indocker::Core::EnvFiles::ArtifactFile.new(:default, artifact_name: :env_files, file_path: "path/to.file")
  ...
  context "#get_from_configuration" do
    it "returns configuration env_file" do
      env_file = Indocker::Core::EnvFiles::ArtifactFile.new(:production_default, artifact_name: :env_files, file_path: "path/to.file")
      subject.add(env_file)
