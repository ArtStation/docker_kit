...
RSpec.describe KuberKit::Preprocessing::FilePreprocessor do
  subject{ KuberKit::Preprocessing::FilePreprocessor.new }
  ...
  it "raises PreprocessingError on any error in preprocessing" do
    ...
    expect{ 
      subject.compile(shell, source_path, destination_path: destination_path, context_helper: test_helper.context_helper) 
    }.to raise_error(KuberKit::Preprocessing::FilePreprocessor::PreprocessingError)
  end
