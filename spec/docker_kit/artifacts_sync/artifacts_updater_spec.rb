RSpec.describe DockerKit::ArtifactsSync::ArtifactsUpdater do
  subject{ DockerKit::ArtifactsSync::ArtifactsUpdater.new }

  class ExampleResolver < DockerKit::ArtifactsSync::AbstractArtifactResolver
  ...
  class ExampleArtifact1 < DockerKit::Core::Artifacts::AbstractArtifact
  end

  class ExampleArtifact2 < DockerKit::Core::Artifacts::AbstractArtifact
  end
  ...
  it "raises error if resolver not found for class" do
    ...
    }.to raise_error(DockerKit::ArtifactsSync::ArtifactsUpdater::ResolverNotFoundError)
  end

  it "raises an error if resolver is not instance of abstract resolver" do
    expect {
      subject.use_resolver(DockerKit, artifact_class: ExampleArtifact1)
