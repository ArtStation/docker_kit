RSpec.describe DockerKit::ImageCompiler::ImageBuildDirCreator do
  subject{ DockerKit::ImageCompiler::ImageBuildDirCreator.new }
  ...
  it "creates a docker ignore file" do
    DockerKit::Container["configs"].docker_ignore_list = ["log", "tmp"]
