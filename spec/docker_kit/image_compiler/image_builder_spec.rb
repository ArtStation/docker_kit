RSpec.describe DockerKit::ImageCompiler::ImageBuilder do
  subject{ DockerKit::ImageCompiler::ImageBuilder.new }
  ...
  before do
    DockerKit::Container.stub("image_compiler.version_tag_builder", TestVersionTagBuilder.new)
  end

  after do
    DockerKit::Container.unstub("image_compiler.version_tag_builder")
  end
