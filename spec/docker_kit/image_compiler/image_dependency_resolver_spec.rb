RSpec.describe DockerKit::ImageCompiler::ImageDependencyResolver do
  subject{ DockerKit::ImageCompiler::ImageDependencyResolver.new }
  ...
  context "#get_recursive_deps" do
    ...
    it "raises exception on circular dependency" do
      ...
      }.to raise_error(DockerKit::ImageCompiler::ImageDependencyResolver::CircularDependencyError)
    end
    ...
    it "raises exception if dependency is not found" do
      ...
      expect{
        subject.get_recursive_deps(image1)
      }.to raise_error(DockerKit::Core::ImageStore::NotFoundError)
    end
  end
