RSpec.describe DockerKit::TemplateReader::Reader do
  subject{ DockerKit::TemplateReader::Reader.new }

  class ExampleTemplateReader < DockerKit::TemplateReader::AbstractTemplateReader
    def read(shell, template, context_helper: nil)
      return {name: template.name}
    end
  end

  class ExampleTemplate1 < DockerKit::Core::Templates::AbstractTemplate
  end

  class ExampleTemplate2 < DockerKit::Core::Templates::AbstractTemplate
  end
  ...
  it "raises error if reader not found for class" do
    ...
    }.to raise_error(DockerKit::TemplateReader::Reader::ReaderNotFoundError)
  end
