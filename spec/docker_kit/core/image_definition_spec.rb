...
RSpec.describe DockerKit::Core::ImageDefinition do
  subject{ DockerKit::Core::ImageDefinition.new(:example_image, "/images/example_image") }

  context "initialize" do
    it "can initialize image with symbol name" do
      definition = DockerKit::Core::ImageDefinition.new(:example_image, "")
