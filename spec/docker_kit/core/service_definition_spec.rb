...
RSpec.describe DockerKit::Core::ServiceDefinition do
  subject{ DockerKit::Core::ServiceDefinition.new(:example_service) }

  context "initialize" do
    it "can initialize service with symbol name" do
      definition = DockerKit::Core::ServiceDefinition.new(:example_service)
