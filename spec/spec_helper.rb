...
RSpec.configure do |config|
  ...
  config.after do
    ...
    Indocker::Container['core.service_store'].reset!
    ...
    Indocker::Container['core.env_file_store'].reset!
    ...
    Indocker::Container['tools.file_presence_checker'].reset!
  end
end
